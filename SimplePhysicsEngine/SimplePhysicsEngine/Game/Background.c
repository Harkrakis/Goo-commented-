...
void ModeButton_Render(Scene *scene)    /// affichage des bouttons pour changer de mode de jeu
{
    ...
    SDL_RenderCopyF(renderer->m_rendererSDL, textures->m_arrow, NULL, &dstRect);
    ...
    SDL_RenderCopyF(renderer->m_rendererSDL, textures->m_arrow1, NULL, &dstRect);
    ...
    SDL_RenderCopyF(renderer->m_rendererSDL, textures->m_moon, NULL, &dstRect);
    ...
    SDL_RenderCopyF(renderer->m_rendererSDL, textures->m_nograv, NULL, &dstRect);
